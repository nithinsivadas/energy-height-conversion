...
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function [astrom, eo] = iauApco13(utc1, utc2, dut1, elong, phi, hm, ....
                                  xp, yp, phpa, tc, rh, wl)

% UTC to other time scales.
[tai1, tai2] = iauUtctai(utc1, utc2);
[tt1, tt2] = iauTaitt(tai1, tai2);
[ut11, ut12] = iauUtcut1(utc1, utc2, dut1);

% Earth barycentric & heliocentric position/velocity (au, au/d).
[ehpv, ebpv] = iauEpv00(tt1, tt2);
...
astrom = iauApco(tt1, tt2, ebpv, ehpv(1,:), x, y, s, theta, elong, phi, ...
                 hm, xp, yp, sp, refa, refb);
