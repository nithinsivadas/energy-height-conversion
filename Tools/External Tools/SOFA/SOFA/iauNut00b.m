...
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function [dpsi, deps] = iauNut00b(date1, date2)
...
el = mod(485868.249036 + (1717915923.2178) * t, TURNAS) * DAS2R;

% Mean anomaly of the Sun. 
elp = mod(1287104.79305 + (129596581.0481) * t, TURNAS) * DAS2R;

% Mean argument of the latitude of the Moon. 
f = mod(335779.526232 + (1739527262.8478) * t, TURNAS) * DAS2R;

% Mean elongation of the Moon from the Sun. 
d = mod(1072260.70369 + (1602961601.2090) * t, TURNAS) * DAS2R;

% Mean longitude of the ascending node of the Moon. 
om = mod(450160.398036 + (-6962890.5431) * t, TURNAS) * DAS2R;
...
for i = NLS:-1:1
    ...
    arg = mod(x(i,1) * el + x(i,2) * elp + x(i,3) * f + x(i,4) * d +...
    x(i,5) * om, D2PI);
    sarg = sin(arg);
    carg = cos(arg);
    
    % Term. 
    dp = dp + (x(i,6) + x(i,7) * t) * sarg + x(i,8) * carg;
    de = de + (x(i,9) + x(i,10) * t) * carg + x(i,11) * sarg;
end
