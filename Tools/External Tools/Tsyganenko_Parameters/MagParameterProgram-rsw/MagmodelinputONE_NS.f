...
c                                                                                c
c     By Zhengrui Qin and Richard Denton, 09/01/2007
c     Modified by Nithin Sivadas, 06/05/2019 to be compatible with gfortran      c
cccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc
C      character yesno*3
      common istart,wst(6)
...
c     This program is to interpolate across the gaps in the one-minute data
     ...
     $ainter(nc),check1(nc),check2(nc),check(nc)
      double precision tyear,datamin(nc+1,1200000)
      dimension idmy(7),dummy(24),correltime(nc),itime(4,1200000)
