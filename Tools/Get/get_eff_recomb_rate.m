function [alpha] = get_eff_recomb_rate(altitudeGrid)
%% get_eff_recomb_rate.m Calculates the effective recombination coefficient
...
%%
    ...
    [isThereNAN, totalNAN] = check_nan(alpha);
