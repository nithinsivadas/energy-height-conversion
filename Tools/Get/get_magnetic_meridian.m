function [meridian] = get_magnetic_meridian(sensorLoc,time,parallel,...
  projectionAltitude,declination)
% get_magnetic_meridian Calculate magnetic meridian values along the input parallels
