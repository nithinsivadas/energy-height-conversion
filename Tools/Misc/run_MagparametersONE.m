function GW=get_tsyganenko_G_W(yyyy,programDir,omniASCDir)
%UNTITLED2 Summary of this function goes here
%   Detailed explanation goes here
% Important:
% Needs g77 installed, and External tool MagParamtersProgram from 
% http://virbo.org/svn/virbo/qindenton/MagParameterProgram-rsw/README.txt
% programDir - is the directory where the executable of this fortran code
% is compiled
...
% Run fortran code only if GW paramters aren't already stored
