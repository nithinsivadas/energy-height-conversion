...
dataFile = '/media/nithin/PFISR_002_006/Nithin/NOAA17/n18_coords_interpolated.txt';
...
omniH5='/home/nithin/Documents/git-repos/LargeFiles/omni/omni.h5';
...
%% Calculate Rc
[timeRc, Rc, divBArr] = get_radius_of_curvature(time,magTime,maginput,xGDZ,kext); 
...
function [timeRc, Rc, divBArr]=get_radius_of_curvature(time,magTime,maginput,xGDZ,kext)
    options = [0,0,0,0,0];
