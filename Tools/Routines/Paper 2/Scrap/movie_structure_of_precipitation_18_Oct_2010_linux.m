...
clear all;
h5FileStr = '/media/nithin/PFISR_002_006/PFISR Processed/Event_List/20101018.001_bc_15sec-full_v110.h5';
h5FileStrNe = '/media/nithin/PFISR_002_006/PFISR Processed/Event_List/20101018.001_bc_15sec-full_v110.h5';
%% Load data
...
dascImage = h5read(h5FileStr,'/DASC/ASI');
temp = dascImage(:,:,asi.indx);
clear dascImage;
