...
timeMinStr = '26 Mar 2008 10:00';
timeMaxStr = '26 Mar 2008 10:02';
...
for itime = timeArray
    ...
    'energySlice',energySlice,'thisTime',time(itime),'contourLineArray',1:30,...
    'contourLabelArray',[5,7,9,12,15,20,25,30],...
    'latLim',[63 67],'lonLim',[-153 -143],'opticalLim',[300 450],...
    'plotContours','Lm','magneticFieldModel',magFieldModelStr,...
