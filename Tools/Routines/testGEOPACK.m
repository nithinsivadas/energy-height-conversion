...
toc
tic
Xfoot = geopack_find_foot_point...
    (find_irbem_magFieldModelNo('TS89'),[],2,thisTime,...
    xGSM(1),xGSM(2),xGSM(3),110,2,thisMaginput,true);
toc
...
NFoot = onera_desp_lib_find_foot_point...
            (find_irbem_magFieldModelNo('TS89'),[0,0,0,0,0],2,thisTime,...
            xGSM(1),...
            xGSM(2),...
            xGSM(3),...
            110,2,thisMaginput);
...
fprintf('GEOPACKFn: %6.2f deg %6.2f deg %6.2f km \n',Xfoot(2),Xfoot(3),Xfoot(1));
